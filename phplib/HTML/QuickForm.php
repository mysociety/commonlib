...
class HTML_QuickForm extends HTML_Common
{
    ...
    {
        include_once( preg_replace('/HTML\/QuickForm.*$/', '', __FILE__ ) . 'HTML/QuickForm/RuleRegistry.php');
    ...
    function &_loadElement($event, $type, $args)
    {
        ...
        include_once( preg_replace('/HTML\/QuickForm.*$/', '', __FILE__ ) . $includeFile);
    ...
    */
    ...
    {
        include_once preg_replace('/HTML\/QuickForm.*$/', '', __FILE__ ) . 'HTML/QuickForm/Renderer/Array.php';
